...
namespace Mangos.World.Handlers
{
    public class WS_Handlers
    {
        public void IntializePacketHandlers()
        {
            ...
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_START_FORWARD] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_START_BACKWARD] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_STOP] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_START_STRAFE_LEFT] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_START_STRAFE_RIGHT] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_STOP_STRAFE] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_JUMP] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_START_TURN_LEFT] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_START_TURN_RIGHT] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_STOP_TURN] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_START_PITCH_UP] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_START_PITCH_DOWN] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_STOP_PITCH] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_SET_RUN_MODE] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_SET_WALK_MODE] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_START_SWIM] = WS_CharMovement.OnStartSwim;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_STOP_SWIM] = WS_CharMovement.OnStopSwim;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_SET_FACING] = WS_CharMovement.OnMovementPacket;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_SET_PITCH] = WS_CharMovement.OnMovementPacket;
            ...
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_HEARTBEAT] = WS_CharMovement.On_MSG_MOVE_HEARTBEAT;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_AREATRIGGER] = WS_CharMovement.On_CMSG_AREATRIGGER;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_MOVE_FALL_LAND] = WS_CharMovement.On_MSG_MOVE_FALL_LAND;
            ...
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_ITEM_QUERY_SINGLE] = Objects.WS_Items.On_CMSG_ITEM_QUERY_SINGLE;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_ITEM_NAME_QUERY] = Objects.WS_Items.On_CMSG_ITEM_NAME_QUERY;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_SETSHEATHED] = WS_Combat.On_CMSG_SETSHEATHED;
            ...
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_AUTOSTORE_BAG_ITEM] = Objects.WS_Items.On_CMSG_AUTOSTORE_BAG_ITEM;
            ...
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_USE_ITEM] = Objects.WS_Items.On_CMSG_USE_ITEM;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_OPEN_ITEM] = Objects.WS_Items.On_CMSG_OPEN_ITEM;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_WRAP_ITEM] = Objects.WS_Items.On_CMSG_WRAP_ITEM;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_SET_AMMO] = WS_Combat.On_CMSG_SET_AMMO;
            ...
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_ATTACKSWING] = WS_Combat.On_CMSG_ATTACKSWING;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_ATTACKSTOP] = WS_Combat.On_CMSG_ATTACKSTOP;
            ...
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.MSG_AUCTION_HELLO] = Auction.WS_Auction.On_MSG_AUCTION_HELLO;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_AUCTION_SELL_ITEM] = Auction.WS_Auction.On_CMSG_AUCTION_SELL_ITEM;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_AUCTION_REMOVE_ITEM] = Auction.WS_Auction.On_CMSG_AUCTION_REMOVE_ITEM;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_AUCTION_LIST_ITEMS] = Auction.WS_Auction.On_CMSG_AUCTION_LIST_ITEMS;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_AUCTION_LIST_OWNER_ITEMS] = Auction.WS_Auction.On_CMSG_AUCTION_LIST_OWNER_ITEMS;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_AUCTION_PLACE_BID] = Auction.WS_Auction.On_CMSG_AUCTION_PLACE_BID;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_AUCTION_LIST_BIDDER_ITEMS] = Auction.WS_Auction.On_CMSG_AUCTION_LIST_BIDDER_ITEMS;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_PETITION_SHOWLIST] = Social.WS_Guilds.On_CMSG_PETITION_SHOWLIST;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_PETITION_BUY] = Social.WS_Guilds.On_CMSG_PETITION_BUY;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_PETITION_SHOW_SIGNATURES] = Social.WS_Guilds.On_CMSG_PETITION_SHOW_SIGNATURES;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_PETITION_QUERY] = Social.WS_Guilds.On_CMSG_PETITION_QUERY;
            WorldServiceLocator._WorldServer.PacketHandlers[Opcodes.CMSG_OFFER_PETITION] = Social.WS_Guilds.On_CMSG_OFFER_PETITION;
