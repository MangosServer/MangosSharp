...
namespace Mangos.World.Player
{
    public class WS_PlayerData
    {
        public class CharacterObject : WS_Base.BaseUnit, IDisposable
        {
            ...
            public static float GetHitFactor(bool MainHand = true, bool Critical = false)
            {
            ...
            public bool IsInCombat => inCombatWith.Count > 0 || checked(NativeMethods.timeGetTime("") - lastPvpAction) < WorldServiceLocator._Global_Constants.DEFAULT_PVP_COMBAT_TIME;
            ...
            public void UpdateManaRegen()
            {
                ...
                float PowerRegen = (float)(Math.Sqrt(Intellect.Base) * 1.0);
            ...
            public override bool IsFriendlyTo(ref WS_Base.BaseUnit Unit)
            {
                ...
                if (Unit is CharacterObject characterObject)
                {
                    ...
                    if (Globals.Functions.HaveFlags((int)cPlayerFlags, 128) && Globals.Functions.HaveFlags((int)characterObject.cPlayerFlags, 128))
                    {
                        return false;
                    }
            ...
            public void AddToCombat(WS_Base.BaseUnit Unit)
            {
                ...
                {
                    lastPvpAction = NativeMethods.timeGetTime("");
                }
                else
                {
            ...
            public void CheckCombat()
            {
                ...
                else if (IsInCombat)
                {
                    ...
                    CharacterObject objCharacter = this;
                    WS_Combat.SetPlayerInCombat(ref objCharacter);
                }
            }
            ...
            public void SendOutOfRangeUpdate()
            {
                ...
                ulong[] GUIDs = guidsForRemoving.ToArray();
                ...
                checked
                {
                    ...
                    try
                    {
                        ...
                        foreach (KeyValuePair<byte, ItemObject> tmpItem in Items)
                        {
                            ...
                            ItemObject updateObject = tmpItem.Value;
            ...
            public void SendCharacterUpdate(bool toNear = true, bool notMe = false)
            {
                ...
                if (toNear && SeenBy.Count > 0)
                {
                    ...
                    try
                    {
                        ...
                        CharacterObject updateObject = this;
            ...
            public void FillStatsUpdateFlags()
            {
                ...
                WS_Combat wS_Combat2 = WorldServiceLocator._WS_Combat;
                objCharacter = this;
                SetUpdateFlag(1107, WS_Combat.GetBasePercentDodge(ref objCharacter, 0));
                WS_Combat wS_Combat3 = WorldServiceLocator._WS_Combat;
                objCharacter = this;
                SetUpdateFlag(1108, WS_Combat.GetBasePercentParry(ref objCharacter, 0));
                WS_Combat wS_Combat4 = WorldServiceLocator._WS_Combat;
                objCharacter = this;
            ...
            public void FillAllUpdateFlags()
            {
                ...
                WS_Combat wS_Combat2 = WorldServiceLocator._WS_Combat;
                objCharacter = this;
                SetUpdateFlag(1110, WS_Combat.GetBasePercentCrit(ref objCharacter, 0));
                byte i2 = 0;
                checked
                {
                    do
                    ...
                    objCharacter = this;
                    SetUpdateFlag(1107, WS_Combat.GetBasePercentDodge(ref objCharacter, 0));
                    WS_Combat wS_Combat5 = WorldServiceLocator._WS_Combat;
                    objCharacter = this;
                    SetUpdateFlag(1108, WS_Combat.GetBasePercentParry(ref objCharacter, 0));
            ...
            {
                Packets.PacketClass packet = Globals.Functions.BuildChatMessage(Sender.GUID, Message, msgType, (LANGUAGES)msgLanguage, WS_Handlers_Chat.GetChatFlag(Sender), ChannelName);
            ...
            {
                string[] Messages = Message.Split(new string[1]
                {
                    Environment.NewLine
                ...
                {
                    Packets.PacketClass packet = Globals.Functions.BuildChatMessage(2147483647uL, Msg, ChatMsg.CHAT_MSG_SYSTEM, LANGUAGES.LANG_GLOBAL);
                    client.Send(ref packet);
                    packet.Dispose();
                }
            ...
            public void CastOnSelf(int SpellID)
            {
                if (WorldServiceLocator._WS_Spells.SPELLs.ContainsKey(SpellID))
                {
                    ...
                    WS_Spells.CastSpellParameters castParams = new WS_Spells.CastSpellParameters(ref Targets, ref Caster, SpellID);
            ...
            public void ApplySpell(int SpellID)
            {
                if (WorldServiceLocator._WS_Spells.SPELLs.ContainsKey(SpellID))
                {
                    ...
                    {
                        WS_Spells.SpellInfo spellInfo2 = WorldServiceLocator._WS_Spells.SPELLs[SpellID];
                        WS_Base.BaseObject caster = this;
            ...
            public void ProhibitSpellSchool(int School, int Time)
            {
                ...
                checked
                {
                    try
                    {
                        ...
                        uint curTime = Globals.Functions.GetTimestamp(DateAndTime.Now);
            ...
            public bool FinishSpell(CurrentSpellTypes SpellType, bool OK = false)
            {
                ...
                {
                    int SpellID = spellCasted[(int)SpellType].SpellID;
                    WS_Spells.SpellInfo spellInfo = WorldServiceLocator._WS_Spells.SPELLs[SpellID];
                    ref CharacterObject character = ref client.Character;
                    WS_Base.BaseUnit Caster2 = character;
                    spellInfo.SendInterrupted(0, ref Caster2);
                    character = (CharacterObject)Caster2;
                    if (!OK)
                    {
                        WS_Spells.SendCastResult(SpellFailedReason.SPELL_FAILED_INTERRUPTED, ref client, SpellID);
                    }
            ...
            public void LearnSkill(int SkillID, short Current = 1, short Maximum = 1)
            {
                checked
                {
                    ...
                    {
                        short num = (short)WorldServiceLocator._Global_Constants.PLAYER_SKILL_INFO_SIZE;
                        short i = 0;
            ...
            {
                ItemObject tmpItem = new ItemObject(ItemEntry, GUID);
                ...
                checked
                {
                    if (srcBag == 0)
                    {
                        if (srcSlot < 23u)
                        {
                            ...
                            byte key;
                            ItemObject Item = (items = Items)[key = srcSlot];
                    ...
                    checked
                    {
                        if (Items.ContainsKey(slot) && Items[slot].GUID == itemGuid)
                        {
                            ...
                            if (slot < 23u)
                            {
                                ...
                                Dictionary<byte, ItemObject> items;
                                byte key;
                                ItemObject Item = (items = Items)[key = slot];
            ...
            public bool ItemADD(ref ItemObject Item)
            {
                ...
                checked
                {
                    ...
                    if (ItemADD_AutoSlot(ref Item) && client != null)
                    {
                        ...
                        CharacterObject objCharacter = this;
                        WS_Quests.OnQuestItemAdd(ref objCharacter, tmpEntry, tmpCount);
                        return true;
                    }
                    return false;
                }
            ...
            {
                byte Slot = WorldServiceLocator._Global_Constants.ITEM_SLOT_NULL;
                checked
                {
                    int OldestTime = (int)Globals.Functions.GetTimestamp(DateAndTime.Now);
                    byte OldestSlot = WorldServiceLocator._Global_Constants.ITEM_SLOT_NULL;
                    byte i = 69;
                    do
                    {
                    ...
                    BuyBackTimeStamp[eSlot] = (int)Globals.Functions.GetTimestamp(DateAndTime.Now);
                ...
                if (Item.ItemInfo.Stackable > 1)
                {
                    ...
                    else if (Item.ItemInfo.BagFamily != 0)
                    {
                        ...
                        do
                        {
                            checked
                            {
                                ...
                                {
                                    foreach (KeyValuePair<byte, ItemObject> slot5 in Items[bag2].Items)
                                    {
                                        if (slot5.Value.ItemEntry == Item.ItemEntry && slot5.Value.StackCount < slot5.Value.ItemInfo.Stackable)
                                        {
                                            int stacked2 = slot5.Value.ItemInfo.Stackable - slot5.Value.StackCount;
                    ...
                    do
                    {
                        checked
                        {
                            ...
                            {
                                int stacked3 = Items[slot6].ItemInfo.Stackable - Items[slot6].StackCount;
                    ...
                    do
                    {
                        checked
                        {
                            ...
                            {
                                foreach (KeyValuePair<byte, ItemObject> slot7 in Items[bag4].Items)
                                {
                                    if (slot7.Value.ItemEntry == Item.ItemEntry && slot7.Value.StackCount < slot7.Value.ItemInfo.Stackable)
                                    {
                                        int stacked4 = slot7.Value.ItemInfo.Stackable - slot7.Value.StackCount;
            ...
            public bool ItemADD_AutoBag(ref ItemObject Item, byte dstBag)
            {
                checked
                {
                    ...
                    if (dstBag == 0)
                    {
                        if (Item.ItemInfo.Stackable > 1)
                        {
                            ...
                            do
                            {
                                ...
                                {
                                    byte stacked2 = (byte)(Items[slot].ItemInfo.Stackable - Items[slot].StackCount);
                                    if (stacked2 >= Item.StackCount)
                                    {
                                        Items[slot].StackCount += Item.StackCount;
                                        Item.Delete();
                    ...
                    WS_Items wS_Items2 = WorldServiceLocator._WS_Items;
                    objCharacter = this;
                    WS_Items.SendInventoryChangeFailure(ref objCharacter, InventoryChangeFailure.EQUIP_ERR_BAG_FULL, Item.GUID, 0uL);
                    return false;
                }
            }
            ...
            public InventoryChangeFailure ItemCANEQUIP(ItemObject Item, byte dstBag, byte dstSlot)
            {
                ...
                WS_Items.ItemInfo ItemInfo = Item.ItemInfo;
                try
                {
                    if (dstBag == 0)
                    {
                        switch (dstSlot)
                        {
                            ...
                            case 18:
                                ...
                                checked
                                {
                                    if (!Globals.Functions.HaveFlag(ItemInfo.AvailableClasses, (byte)((int)Classe - 1)))
                                    {
                                        return InventoryChangeFailure.EQUIP_ERR_YOU_CAN_NEVER_USE_THAT_ITEM;
                                    }
                                    if (!Globals.Functions.HaveFlag(ItemInfo.AvailableRaces, (byte)((int)Race - 1)))
                                    {
                ...
                catch (Exception ex)
                {
                    ...
                    InventoryChangeFailure ItemCANEQUIP = InventoryChangeFailure.EQUIP_ERR_CANT_DO_RIGHT_NOW;
            ...
            public void ItemSPLIT(byte srcBag, byte srcSlot, byte dstBag, byte dstSlot, int Count)
            {
                ...
                checked
                {
                    ...
                    else if (dstItem == null)
                    {
                        ...
                        ItemObject tmpItem = new ItemObject(srcItem.ItemEntry, GUID)
                        {
                            StackCount = Count
                        };
                        dstItem = tmpItem;
                        tmpItem.Save();
                        ItemSETSLOT(ref tmpItem, dstBag, dstSlot);
                        Packets.UpdatePacketClass SMSG_UPDATE_OBJECT = new Packets.UpdatePacketClass();
                        Packets.UpdateClass tmpUpdate = new Packets.UpdateClass(WorldServiceLocator._Global_Constants.FIELD_MASK_SIZE_ITEM);
                        try
                        {
                            ...
                            WS_Network.ClientClass clientClass = client;
            ...
            public void ItemSWAP(byte srcBag, byte srcSlot, byte dstBag, byte dstSlot)
            {
                ...
                if ((srcBag == 0 && srcSlot == dstBag && dstBag > 0) || (dstBag == 0 && dstSlot == srcBag && srcBag > 0))
                {
                    WS_Items wS_Items2 = WorldServiceLocator._WS_Items;
                    CharacterObject objCharacter = this;
                    WS_Items.SendInventoryChangeFailure(ref objCharacter, (InventoryChangeFailure)errCode, Items[srcSlot].GUID, 0uL);
                    return;
                }
                checked
                {
                    try
                    {
                        unchecked
                        {
                            if (srcBag > 0 && dstBag > 0)
                            {
                                ...
                                ItemObject tmp4 = Items[dstBag].Items[dstSlot];
                                Items[dstBag].Items[dstSlot] = Items[srcBag].Items[srcSlot];
                            ...
                            if (srcBag > 0)
                            {
                                ...
                                if (!Items.ContainsKey(dstSlot))
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (dstSlot < 23u)
                                        {
                                            Dictionary<byte, ItemObject> items;
                                            byte key;
                                            ItemObject Item = (items = Items)[key = dstSlot];
                                ...
                                if (!Items[srcBag].Items.ContainsKey(srcSlot))
                                {
                                    ...
                                    if (dstSlot < 23u)
                                    {
                                        Dictionary<byte, ItemObject> items;
                                        byte key;
                                        ItemObject Item = (items = Items[srcBag].Items)[key = srcSlot];
                                ...
                                if (!Items[dstBag].Items.ContainsKey(dstSlot))
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (srcSlot < 23u)
                                        {
                                            Dictionary<byte, ItemObject> items;
                                            byte key;
                                            ItemObject Item = (items = Items[dstBag].Items)[key = dstSlot];
                                            UpdateRemoveItemStats(ref Item, srcSlot);
                                            items[key] = Item;
                                        }
                                    }
                    ...
                    finally
                    {
                        if (errCode != 0)
                        {
                            WS_Items wS_Items3 = WorldServiceLocator._WS_Items;
                            CharacterObject objCharacter = this;
                            WS_Items.SendInventoryChangeFailure(ref objCharacter, (InventoryChangeFailure)errCode, ItemGetGUID(srcBag, srcSlot), ItemGetGUID(dstBag, dstSlot));
                        }
                    }
                }
            }
            ...
            public void UpdateAddItemStats(ref ItemObject Item, byte slot)
            {
                ...
                checked
                {
                    ...
                    do
                    {
                        ...
                        {
                            WS_Spells.SpellInfo SpellInfo = WorldServiceLocator._WS_Spells.SPELLs[Item.ItemInfo.Spells[i].SpellID];
                ...
                checked
                {
                    try
                    {
                        ...
                        else
                        {
                            ...
                            for (int index2 = 0; index2 < Menu.Menus.Count; index2++)
                            {
                        ...
                        else
                        {
                            ...
                            for (int index = 0; index < qMenu.Names.Count; index++)
                            {
            ...
            {
                int ZoneFlag = WorldServiceLocator._WS_Maps.GetAreaFlag(positionX, positionY, checked((int)MapID));
                ...
                WS_Maps.TArea tArea = WorldServiceLocator._WS_Maps.AreaTable[ZoneFlag];
                CharacterObject objCharacter = this;
                ...
                checked
                {
                    try
                    {
                        ...
                        if (underWaterTimer.DrowningValue < 0)
                        {
                            ...
                            int damage = (int)(0.1f * Life.Maximum * underWaterTimer.DrowningDamage);
            ...
            public int GetReputationValue(int FactionTemplateID)
            {
                ...
                checked
                {
                    int points = Globals.Functions.HaveFlag((uint)WorldServiceLocator._WS_DBCDatabase.FactionInfo[FactionID].flags[0], (byte)((int)Race - 1)) ? WorldServiceLocator._WS_DBCDatabase.FactionInfo[FactionID].rep_stats[0] : (Globals.Functions.HaveFlag((uint)WorldServiceLocator._WS_DBCDatabase.FactionInfo[FactionID].flags[1], (byte)((int)Race - 1)) ? WorldServiceLocator._WS_DBCDatabase.FactionInfo[FactionID].rep_stats[1] : (Globals.Functions.HaveFlag((uint)WorldServiceLocator._WS_DBCDatabase.FactionInfo[FactionID].flags[2], (byte)((int)Race - 1)) ? WorldServiceLocator._WS_DBCDatabase.FactionInfo[FactionID].rep_stats[2] : (Globals.Functions.HaveFlag((uint)WorldServiceLocator._WS_DBCDatabase.FactionInfo[FactionID].flags[3], (byte)((int)Race - 1)) ? WorldServiceLocator._WS_DBCDatabase.FactionInfo[FactionID].rep_stats[3] : 0)));
                    if (Reputation[WorldServiceLocator._WS_DBCDatabase.FactionInfo[FactionID].VisibleID].Flags > 0)
                    {
            ...
            public override void DealDamage(int Damage, WS_Base.BaseUnit Attacker = null)
            {
                ...
                {
                    WS_Spells.CastSpellParameters castSpellParameters = spellCasted[1];
            ...
            public void Login()
            {
                ...
                try
                {
                    ...
                    {
                        WS_CharMovement.MAP_Load(CellX, CellY, MapID);
                    }
                }
                catch (Exception ex2)
                {
                ...
                WS_PlayerHelper wS_PlayerHelper = WorldServiceLocator._WS_PlayerHelper;
                ref WS_Network.ClientClass reference = ref client;
                CharacterObject Character = this;
                WS_PlayerHelper.SendBindPointUpdate(ref reference, ref Character);
                WS_PlayerHelper wS_PlayerHelper2 = WorldServiceLocator._WS_PlayerHelper;
                ref WS_Network.ClientClass reference2 = ref client;
                Character = this;
                WS_PlayerHelper.Send_SMSG_SET_REST_START(ref reference2, ref Character);
                WS_PlayerHelper wS_PlayerHelper3 = WorldServiceLocator._WS_PlayerHelper;
                ref WS_Network.ClientClass reference3 = ref client;
                Character = this;
                WS_PlayerHelper.SendTutorialFlags(ref reference3, ref Character);
                SendProficiencies();
                WS_PlayerHelper wS_PlayerHelper4 = WorldServiceLocator._WS_PlayerHelper;
                ref WS_Network.ClientClass reference4 = ref client;
                Character = this;
                WS_PlayerHelper.SendInitialSpells(ref reference4, ref Character);
                WS_PlayerHelper wS_PlayerHelper5 = WorldServiceLocator._WS_PlayerHelper;
                ref WS_Network.ClientClass reference5 = ref client;
                Character = this;
                WS_PlayerHelper.SendFactions(ref reference5, ref Character);
                WS_PlayerHelper wS_PlayerHelper6 = WorldServiceLocator._WS_PlayerHelper;
                ref WS_Network.ClientClass reference6 = ref client;
                Character = this;
                WS_PlayerHelper.SendActionButtons(ref reference6, ref Character);
                WS_PlayerHelper wS_PlayerHelper7 = WorldServiceLocator._WS_PlayerHelper;
                ref WS_Network.ClientClass reference7 = ref client;
                Character = this;
                WS_PlayerHelper.SendInitWorldStates(ref reference7, ref Character);
                Life.Current = Life.Maximum;
                Mana.Current = Mana.Maximum;
                FillAllUpdateFlags();
                SendUpdate();
                ...
                Globals.Functions.SendTimeSyncReq(ref client);
                UpdateAuraDurations();
                FullyLoggedIn = true;
                UpdateManaRegen();
            }
                ...
                checked
                {
                    if (decimal.Compare(new decimal(TransportGUID), 0m) > 0)
                    {
                        if (WorldServiceLocator._CommonGlobalFunctions.GuidIsMoTransport(TransportGUID) && WorldServiceLocator._WorldServer.WORLD_TRANSPORTs.ContainsKey(TransportGUID))
                        {
                            ...
                            WS_Transports.TransportObject transportObject = WorldServiceLocator._WorldServer.WORLD_TRANSPORTs[TransportGUID];
                            WS_Base.BaseUnit Unit = this;
            ...
            public void SendProficiencies()
            {
                ...
                checked
                {
                    ...
                    Globals.Functions.SendProficiency(ref client, 4, ProficiencyFlags);
                    ProficiencyFlags = 0;
                    if (HaveSpell(196))
                    {
                        ProficiencyFlags++;
                    ...
                    Globals.Functions.SendProficiency(ref client, 2, ProficiencyFlags);
                }
            }
            ...
            public void Initialize()
            {
                ...
                checked
                {
                    ...
                    ITEM_SUBCLASS AmmoType = ITEM_SUBCLASS.ITEM_SUBCLASS_LIQUID;
                    ...
                    do
                    {
                        if (Items.ContainsKey(i) && Items[i].ItemInfo.ObjectClass == ITEM_CLASS.ITEM_CLASS_QUIVER)
                        {
                            foreach (KeyValuePair<byte, ItemObject> slot in Items[i].Items)
                            {
                                ...
                                {
                                    CharManagementHandler charManagementHandler = WorldServiceLocator._CharManagementHandler;
                                    CharacterObject objCharacter = this;
            ...
            public CharacterObject()
            {
                ...
                Faction = 0;
                CharacterObject Character_ = this;
            ...
            public CharacterObject(ref WS_Network.ClientClass ClientVal, ulong GuidVal)
            {
                ...
                if (Model == 0)
                {
                    Model = Globals.Functions.GetRaceModel(Race, (int)Gender);
                }
                ...
                SpellQuery.Clear();
                string[] tmp = Strings.Split(MySQLQuery.Rows[0].As<string>("char_skillList"));
                checked
                {
                    if (tmp.Length > 0)
                    {
                        ...
                        for (int i2 = 0; i2 <= num; i2++)
                        {
                            ...
                            {
                                string[] tmp5 = Strings.Split(tmp[i2], ":");
                                if (tmp5.Length == 3)
                                {
                    ...
                    if (tmp.Length > 0)
                    {
                        uint currentTimestamp = Globals.Functions.GetTimestamp(DateAndTime.Now);
                        int num2 = tmp.Length - 1;
                        for (int i3 = 0; i3 <= num2; i3++)
                        {
                            ...
                            string[] tmp4 = Strings.Split(tmp[i3], ":");
                            if (tmp4.Length != 3)
                            {
                                continue;
                            }
                            int AuraSlot = Conversions.ToInteger(tmp4[0]);
                            int AuraSpellID = Conversions.ToInteger(tmp4[1]);
                            long AuraExpire = Conversions.ToLong(tmp4[2]);
                    ...
                    while (i <= 63);
                    uint ForceRestrictions = MySQLQuery.Rows[0].As<uint>("force_restrictions");
                    ...
                    try
                    {
                        ...
                        while (enumerator2.MoveNext())
                        {
                            ...
                            {
                                ItemObject tmpItem = WS_Items.LoadItemByGUID(row.As<long, ulong>("item_guid"), this, row.As<byte>("item_slot") < 19u);
            ...
            public void SaveAsNewCharacter(int Account_ID)
            {
                ...
                string tmpValues = " VALUES (" + Conversions.ToString(Account_ID);
                ...
                tmpValues += ", \"\"";
                temp.Clear();
                byte[] tutorialFlags = TutorialFlags;
                ...
                tmpValues = tmpValues + ", \"" + Strings.Join(temp.ToArray()) + "\"";
                temp.Clear();
                uint[] zonesExplored = ZonesExplored;
                checked
                {
                    for (int j = 0; j < zonesExplored.Length; j++)
                    {
                        byte Flag2 = (byte)zonesExplored[j];
                        temp.Add(Flag2);
                    }
                    tmpCMD += ", char_mapExplored";
                    tmpValues = tmpValues + ", \"" + Strings.Join(temp.ToArray()) + "\"";
                    temp.Clear();
                    WS_PlayerHelper.TReputation[] reputation = Reputation;
                ...
                checked
                {
                    ...
                    for (int i = 0; i <= num; i++)
                    {
                        if (ActiveSpells[i] != null && (ActiveSpells[i].SpellDuration == WorldServiceLocator._Global_Constants.SPELL_DURATION_INFINITE || ActiveSpells[i].SpellDuration > 10000))
                        {
                            ...
                            {
                                expire = Globals.Functions.GetTimestamp(DateAndTime.Now) + ActiveSpells[i].SpellDuration / 1000;
                            }
                    ...
                    temp.Clear();
                    uint[] zonesExplored = ZonesExplored;
                    foreach (uint Flag3 in zonesExplored)
                    {
                        temp.Add(Flag3);
                    }
            ...
            public void GroupUpdate()
            {
                if (Group != null && (ulong)GroupUpdateFlag != 0)
                {
                    ...
                    CharacterObject objCharacter = this;
                    Packets.PacketClass Packet = WS_Group.BuildPartyMemberStats(ref objCharacter, GroupUpdateFlag);
                    GroupUpdateFlag = 0u;
                    if (Packet != null)
                    {
            ...
            public void GroupUpdate(int Flag)
            {
                if (Group != null)
                {
                    WS_Group wS_Group = WorldServiceLocator._WS_Group;
                    CharacterObject objCharacter = this;
                    Packets.PacketClass Packet = WS_Group.BuildPartyMemberStats(ref objCharacter, checked((uint)Flag));
                    if (Packet != null)
                    {
                        Group.Broadcast(Packet);
                    }
            ...
            public bool TalkAddQuest(ref WS_QuestInfo Quest)
            {
                ...
                checked
                {
                    do
                    {
                        ...
                        {
                            WS_Quests.CreateQuest(ref TalkQuests[i], ref Quest);
                            ...
                            {
                                WS_QuestsBase obj2 = TalkQuests[i];
                                CharacterObject objCharacter = this;
            ...
            public bool TalkUpdateQuest(byte QuestSlot)
            {
                ...
                checked
                {
                    ...
                    {
                        int tmpTimer = (int)(TalkQuests[QuestSlot].TimeEnd - Globals.Functions.GetTimestamp(DateAndTime.Now));
                    }
