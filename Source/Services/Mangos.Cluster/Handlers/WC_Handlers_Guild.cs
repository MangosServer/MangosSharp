...
namespace Mangos.Cluster.Handlers
{
    ...
    {
        public void On_CMSG_GUILD_QUERY(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            ...
            ClusterServiceLocator._WC_Guild.SendGuildQuery(ref client, guildId);
        }

        public void On_CMSG_GUILD_ROSTER(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            // packet.GetInt16()

            ClusterServiceLocator._WorldCluster.Log.WriteLine(LogType.DEBUG, "[{0}:{1}] CMSG_GUILD_ROSTER", client.IP, client.Port);
            ClusterServiceLocator._WC_Guild.SendGuildRoster(ref client.Character);
        }

        public void On_CMSG_GUILD_CREATE(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            ...
            {
                ClusterServiceLocator._WC_Guild.SendGuildResult(ref client, GuildCommand.GUILD_CREATE_S, GuildError.GUILD_ALREADY_IN_GUILD);
                return;
            }

            // DONE: Create guild data
            var MySQLQuery = new DataTable();
            ClusterServiceLocator._WorldCluster.CharacterDatabase.Query(string.Format("INSERT INTO guilds (guild_name, guild_leader, guild_cYear, guild_cMonth, guild_cDay) VALUES (\"{0}\", {1}, {2}, {3}, {4}); SELECT guild_id FROM guilds WHERE guild_name = \"{0}\";", guildName, (object)client.Character.Guid, (object)(DateAndTime.Now.Year - 2006), (object)DateAndTime.Now.Month, (object)DateAndTime.Now.Day), MySQLQuery);
            ClusterServiceLocator._WC_Guild.AddCharacterToGuild(ref client.Character, Conversions.ToInteger(MySQLQuery.Rows[0]["guild_id"]), 0);
        }

        public void On_CMSG_GUILD_INFO(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            packet.GetInt16();
            ClusterServiceLocator._WorldCluster.Log.WriteLine(LogType.DEBUG, "[{0}:{1}] CMSG_GUILD_INFO", client.IP, client.Port);
            if (!client.Character.IsInGuild)
            {
                ClusterServiceLocator._WC_Guild.SendGuildResult(ref client, GuildCommand.GUILD_CREATE_S, GuildError.GUILD_PLAYER_NOT_IN_GUILD);
                return;
            }
        ...
        public void On_CMSG_GUILD_RANK(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            ...
            {
                ClusterServiceLocator._WC_Guild.SendGuildResult(ref client, GuildCommand.GUILD_CREATE_S, GuildError.GUILD_PERMISSIONS);
                return;
            }
            ...
            ClusterServiceLocator._WC_Guild.SendGuildQuery(ref client, client.Character.Guild.ID);
            ClusterServiceLocator._WC_Guild.SendGuildRoster(ref client.Character);
        }

        public void On_CMSG_GUILD_ADD_RANK(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            if (packet.Data.Length - 1 < 6)
                return;
            packet.GetInt16();
            ...
            {
                ClusterServiceLocator._WC_Guild.SendGuildResult(ref client, GuildCommand.GUILD_CREATE_S, GuildError.GUILD_INTERNAL);
                return;
            }
            ...
            for (int i = 0; i <= 9; i++)
            {
                if (string.IsNullOrEmpty(client.Character.Guild.Ranks[i]))
                {
                    ...
                    client.Character.Guild.RankRights[i] = GuildRankRights.GR_RIGHT_GCHATLISTEN | GuildRankRights.GR_RIGHT_GCHATSPEAK;
        ...
        public void On_CMSG_GUILD_DEL_RANK(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            packet.GetInt16();
        ...
        public void On_CMSG_GUILD_LEADER(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            if (packet.Data.Length - 1 < 6)
                return;
            packet.GetInt16();
            ...
            if (playerName.Length < 2)
                return;
            playerName = ClusterServiceLocator._Functions.CapitalizeName(ref playerName);
            if (!client.Character.IsInGuild)
            {
                ClusterServiceLocator._WC_Guild.SendGuildResult(ref client, GuildCommand.GUILD_CREATE_S, GuildError.GUILD_PLAYER_NOT_IN_GUILD);
                return;
            ...
            var MySQLQuery = new DataTable();
            ClusterServiceLocator._WorldCluster.CharacterDatabase.Query("SELECT char_guid, char_guildId, char_guildrank FROM characters WHERE char_name = '" + playerName + "';", MySQLQuery);
            if (MySQLQuery.Rows.Count == 0)
            {
                ClusterServiceLocator._WC_Guild.SendGuildResult(ref client, GuildCommand.GUILD_INVITE_S, GuildError.GUILD_PLAYER_NOT_FOUND, playerName);
                return;
            }
            else if (Conversions.ToUInteger(MySQLQuery.Rows[0]["char_guildId"]) != client.Character.Guild.ID)
            {
                ClusterServiceLocator._WC_Guild.SendGuildResult(ref client, GuildCommand.GUILD_INVITE_S, GuildError.GUILD_PLAYER_NOT_IN_GUILD_S, playerName);
                return;
            }
            ...
            ulong argnotTo = 0UL;
            ClusterServiceLocator._WC_Guild.BroadcastToGuild(ref response, ref client.Character.Guild, notTo: ref argnotTo);
            response.Dispose();
        }

        public void On_MSG_SAVE_GUILD_EMBLEM(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            ...
            ulong argnotTo = 0UL;
            ClusterServiceLocator._WC_Guild.BroadcastToGuild(ref packet_event, ref client.Character.Guild, notTo: ref argnotTo);
        ...
        public void On_CMSG_GUILD_DISBAND(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            // packet.GetInt16()
            ...
            foreach (ulong Member in tmpArray)
            {
                if (ClusterServiceLocator._WorldCluster.CHARACTERs.ContainsKey(Member))
                {
                    ...
                    ClusterServiceLocator._WC_Guild.RemoveCharacterFromGuild(ref argobjCharacter);
                    tmp[Member] = argobjCharacter;
                    ClusterServiceLocator._WorldCluster.CHARACTERs[Member].Client.SendMultiplyPackets(ref response);
                }
                else
                {
        ...
        public void On_CMSG_GUILD_MOTD(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
        ...
        public void On_CMSG_GUILD_SET_OFFICER_NOTE(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            if (packet.Data.Length - 1 < 6)
                return;
            packet.GetInt16();
        ...
        public void On_CMSG_GUILD_SET_PUBLIC_NOTE(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            if (packet.Data.Length - 1 < 6)
                return;
            packet.GetInt16();
        ...
        public void On_CMSG_GUILD_REMOVE(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            if (packet.Data.Length - 1 < 6)
                return;
            packet.GetInt16();
            ...
            var q = new DataTable();
            ClusterServiceLocator._WorldCluster.CharacterDatabase.Query("SELECT char_guid FROM characters WHERE char_name = '" + playerName + "';", q);
            ...
            {
                ClusterServiceLocator._WC_Guild.SendGuildResult(ref client, GuildCommand.GUILD_QUIT_S, GuildError.GUILD_LEADER_LEAVE);
                return;
            }
            ...
            ClusterServiceLocator._WC_Guild.BroadcastToGuild(ref response, ref client.Character.Guild, notTo: ref argnotTo);
            response.Dispose();
            ClusterServiceLocator._WC_Guild.RemoveCharacterFromGuild(ref objCharacter);
        }

        public void On_CMSG_GUILD_PROMOTE(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            if (packet.Data.Length - 1 < 6)
                return;
            packet.GetInt16();
            ...
            var q = new DataTable();
            ClusterServiceLocator._WorldCluster.CharacterDatabase.Query("SELECT char_guid FROM characters WHERE char_name = '" + playerName.Replace("'", "_") + "';", q);

            // DONE: Promoted checks
            if (q.Rows.Count == 0)
            {
                ClusterServiceLocator._WC_Guild.SendGuildResult(ref client, GuildCommand.GUILD_INVITE_S, GuildError.GUILD_NAME_INVALID);
                return;
            }
            else if (!ClusterServiceLocator._WorldCluster.CHARACTERs.ContainsKey(Conversions.ToULong(q.Rows[0]["char_guid"])))
            {
            ...
            {
                ClusterServiceLocator._WC_Guild.SendGuildResult(ref client, GuildCommand.GUILD_INVITE_S, GuildError.GUILD_PERMISSIONS);
                return;
            }
            else if (objCharacter.GuildRank == ClusterServiceLocator._Global_Constants.GUILD_RANK_MIN)
            {
                ClusterServiceLocator._WC_Guild.SendGuildResult(ref client, GuildCommand.GUILD_INVITE_S, GuildError.GUILD_INTERNAL);
                return;
            }
        ...
        public void On_CMSG_GUILD_DEMOTE(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            if (packet.Data.Length - 1 < 6)
                return;
            packet.GetInt16();
        ...
        // User Options
        public void On_CMSG_GUILD_INVITE(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            if (packet.Data.Length - 1 < 6)
                return;
            packet.GetInt16();
            ...
            {
                ClusterServiceLocator._WC_Guild.SendGuildResult(ref client, GuildCommand.GUILD_INVITE_S, GuildError.ALREADY_IN_GUILD, playerName);
                return;
            }
            else if (objCharacter.Side != client.Character.Side)
            {
                ClusterServiceLocator._WC_Guild.SendGuildResult(ref client, GuildCommand.GUILD_INVITE_S, GuildError.GUILD_NOT_ALLIED, playerName);
                return;
            }
            else if (objCharacter.GuildInvited != 0L)
            {
                ClusterServiceLocator._WC_Guild.SendGuildResult(ref client, GuildCommand.GUILD_INVITE_S, GuildError.ALREADY_INVITED_TO_GUILD, playerName);
                return;
            }
        ...
        public void On_CMSG_GUILD_ACCEPT(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            ...
            ClusterServiceLocator._WC_Guild.AddCharacterToGuild(ref client.Character, (int)client.Character.GuildInvited);
            ...
            response.Dispose();
            ClusterServiceLocator._WC_Guild.SendGuildRoster(ref client.Character);
            ClusterServiceLocator._WC_Guild.SendGuildMOTD(ref client.Character);
        }

        public void On_CMSG_GUILD_DECLINE(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            client.Character.GuildInvited = 0U;
            if (ClusterServiceLocator._WorldCluster.CHARACTERs.ContainsKey((ulong)Conversions.ToLong(client.Character.GuildInvitedBy)))
            {
                ...
                response.AddString(client.Character.Name);
                ClusterServiceLocator._WorldCluster.CHARACTERs[(ulong)Conversions.ToLong(client.Character.GuildInvitedBy)].Client.Send(ref response);
                response.Dispose();
            }
        }

        public void On_CMSG_GUILD_LEAVE(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            // packet.GetInt16()
            ...
            ClusterServiceLocator._WC_Guild.RemoveCharacterFromGuild(ref client.Character);
            ClusterServiceLocator._WC_Guild.SendGuildResult(ref client, GuildCommand.GUILD_QUIT_S, GuildError.GUILD_PLAYER_NO_MORE_IN_GUILD, client.Character.Name);
            var response = new Packets.PacketClass(OPCODES.SMSG_GUILD_EVENT);
        ...
        public void On_CMSG_TURN_IN_PETITION(ref Packets.PacketClass packet, ref WC_Network.ClientClass client)
        {
            ...
            // DONE: Get info
            var q = new DataTable();
            ClusterServiceLocator._WorldCluster.CharacterDatabase.Query("SELECT * FROM petitions WHERE petition_itemGuid = " + (itemGuid - ClusterServiceLocator._Global_Constants.GUID_ITEM) + " LIMIT 1;", q);
            if (q.Rows.Count == 0)
                return;
            ...
            ClusterServiceLocator._WorldCluster.CharacterDatabase.Query(string.Format("INSERT INTO guilds (guild_name, guild_leader, guild_cYear, guild_cMonth, guild_cDay) VALUES ('{0}', {1}, {2}, {3}, {4}); SELECT guild_id FROM guilds WHERE guild_name = '{0}';", Name, (object)client.Character.Guid, (object)(DateAndTime.Now.Year - 2006), (object)DateAndTime.Now.Month, (object)DateAndTime.Now.Day), q2);
            ClusterServiceLocator._WC_Guild.AddCharacterToGuild(ref client.Character, Conversions.ToInteger(q2.Rows[0]["guild_id"]), 0);
            ...
            for (byte i = 1; i <= 9; i++)
            {
                if (ClusterServiceLocator._WorldCluster.CHARACTERs.ContainsKey(Conversions.ToULong(q.Rows[0]["petition_signedMember" + i])))
                {
                    ...
                    ClusterServiceLocator._WC_Guild.AddCharacterToGuild(ref argobjCharacter, Conversions.ToInteger(q2.Rows[0]["guild_id"]));
