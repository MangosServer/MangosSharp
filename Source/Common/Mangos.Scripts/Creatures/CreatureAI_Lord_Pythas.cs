...
{
    public class CreatureAI_Lord_Pythas : World.AI.WS_Creatures_AI.BossAI
    {
        ...
        public CreatureAI_Lord_Pythas(ref World.Objects.WS_Creatures.CreatureObject Creature) : base(ref Creature)
        {
            AllowedMove = false;
